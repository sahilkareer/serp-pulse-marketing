...
const DEFAULT_SHIPPED = [
  ...
  { label: 'Remote MCP server with 17 tools', note: 'Live' },
  { label: 'Growth monitoring dashboard', note: 'Live' },
  { label: 'SEO Weather — market volatility tracking', note: 'New' },
  { label: 'Branded vs Non-Branded keyword analysis', note: 'New' },
  { label: 'Industry segmentation for SEO Weather', note: 'New' },
  { label: 'Score spike alerts with on/off toggle', note: 'New' },
  { label: 'Bulk project connection (Select All)', note: 'New' },
  { label: 'Page-level GA4 behavior analysis', note: 'New' },
  { label: 'Razorpay payment integration', note: 'New' },
  { label: 'Admin payment dashboard', note: 'New' },
  { label: 'Refund webhook with auto-downgrade', note: 'New' },
  { label: '12-month historical data storage', note: 'New' },
...
const DEFAULT_UPCOMING = [
  ...
  { status: 'Next Up',     title: 'Long-lived MCP API Tokens', desc: 'Replace the current 7-day JWT tokens with permanent API tokens so your MCP server connection never expires unexpectedly.' },
  { status: 'Next Up',     title: 'Email Notifications', desc: 'Get notified by email when volatility spikes, projects drop in traffic, or your AI citations change. Configurable thresholds per project.' },
  { status: 'Planned',    title: 'Client Dashboard Customization', desc: 'Let clients see only what matters to them. Custom layouts, filtered views, and branded access portals per client.' },
  { status: 'Planned',    title: 'Subscription Billing Management', desc: 'Self-service plan upgrades, downgrades, billing history, and invoice downloads directly from the Settings page.' },
